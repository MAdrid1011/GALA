...
旧记录曾统一列出相对 Base ASIC 的周期比；其中 `1000`、`0100`、`1100` 的该口径已废弃，
不得作为正式加速比。有效硬件联合项相对 Base ASIC 的加速比分别为 `1010=1.598617x`、
`0101=1.999808x` 和 `1111=2.689854x`；查询参考 `1.445679x`、驻留参考 `1.443210x`、
