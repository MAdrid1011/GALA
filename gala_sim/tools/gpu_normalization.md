...
calibration vectors. Stage weights
are derived from measured work and sum to one.  Calibration rates are used
only within their measured batch range; local and Orin entries must use the
same work unit and configuration hash.
